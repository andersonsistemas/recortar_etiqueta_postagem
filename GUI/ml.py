...
def processar_pdf(caminho_pdf):
    try:
        ...
        page1.set_cropbox(fitz.Rect(30, 140, 290, 570))  # Aplica o recorte

        # Segunda página - recorte
        page2 = doc[1]  # Obtém a segunda página
        page2.set_cropbox(fitz.Rect(2, 0, 590, 755))  # Aplica o recorte
        ...
        doc1.save(f"{timestamp}_ML.pdf")  # Salva com o nome formatado

        messagebox.showinfo("Sucesso", f"O arquivo {timestamp}_ML.pdf foi processado e salvo com sucesso!")
...
root = tk.Tk()
root.title("Mercado Livre - Recorte")
