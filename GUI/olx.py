...
def processar_pdf(caminho_pdf):
    try:
        ...
        page1.set_cropbox(fitz.Rect(240, 20, 580, 520))  # Aplica o recorte

        # Segunda página - recorte
        page2 = doc[1]  # Obtém a segunda página
        page2.set_cropbox(fitz.Rect(0, 20, 594, 792))  # Aplica o recorte
        ...
        doc1.save(f"{timestamp}_OLX.pdf")  # Salva com o nome formatado
...
root = tk.Tk()
root.title("OLX Etiqueta - Recorte")
